...
- **Displej** : 10-cifarski LCD ekran

- **Funkcije** : 56 funkcija, uključujući statističke i trigonometrijske operacije

- **Napajanje** : Baterijsko

- **Materijal** : Plastično kućište i tasteri

- **Dimenzije** : 200 x 115 x 20 mm

- Ovaj kalkulator je dostupan u više boja, uključujući plavu, zelenu, roze i narandžastu
